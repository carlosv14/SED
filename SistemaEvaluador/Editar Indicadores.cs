            ...
            try
            {
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    if (dt.Rows[i][0].ToString() != n_gen)
                    {
                        ...
                        dataGridView1.Rows[dataGridView1.Rows.Count - 2].Cells["NOMBRE"].Value = n_gen;
                        dataGridView1.Rows[dataGridView1.Rows.Count - 2].Cells["PESO"].Value = dt.Rows[i][1].ToString();
                        indicadores.Add(new Indicadores_Arr(n_gen,float.Parse(dt.Rows[i][1].ToString()),int.Parse(dt.Rows[i][4].ToString())));
                    }
                    if (dt.Rows[i][0].ToString() == n_gen)
                    {
                        dataGridView1.Rows.Add();
                        dataGridView1.Rows[dataGridView1.Rows.Count - 2].Cells["NOMBRE"].Value = " ---"+dt.Rows[i][2].ToString();
                        dataGridView1.Rows[dataGridView1.Rows.Count - 2].Cells["PESO"].Value = dt.Rows[i][3].ToString();
